        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-muted-foreground text-lg leading-relaxed mb-8">
              Seit über 30 Jahren bringen wir die authentischen Aromen Italiens nach
              Berlin-Lichterfelde. Unsere Küche vereint traditionelle Familienrezepte
              mit frischen, hochwertigen Zutaten - von der hausgemachten Pasta bis
              zur Pizza aus dem Steinofen.
            </p>
